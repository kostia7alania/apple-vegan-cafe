...
- 2026-07-17 (ночь): **R9 HANDOVER-th.md** — полная тайская инструкция для семьи (8 секций, точные подписи кнопок из config.yml, PWA-установка на телефон, 6 плейсхолдеров под скриншоты — добавить при передаче); **quality-sweep**: код-ревью ночного диффа (без замечаний: Seo og-блок аккуратный,條ditional Grab корректен, дублей meta нет) + Lighthouse 5 новых страниц (perf/a11y зелёные, SEO-балл ограничен намеренным pre-launch noindex)

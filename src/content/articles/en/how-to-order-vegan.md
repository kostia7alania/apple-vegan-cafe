...
Thai is a tonal language, but do not let that stop you: say it slowly, point at the menu, and most
cooks will meet you halfway. Showing the Thai script on your phone screen works just as well.

## Where animal ingredients hide

- **Fish sauce (น้ำปลา, nam pla)** is the default seasoning in most savoury Thai dishes — soups,
  salads, stir-fries, fried rice. If you only learn one phrase, make it "mai sai nam pla".
- **Oyster sauce** goes into many stir-fried vegetable dishes, including the innocent-looking
  stir-fried morning glory.
- **Shrimp paste (กะปิ, gapi)** is usually pounded into curry pastes and into the dressing of som
  tam, the green papaya salad — which often gets dried shrimp on top as well.
- **Egg** is normally scrambled into fried rice and pad thai unless you ask otherwise.
- **Condensed and evaporated milk** sweeten Thai iced tea, iced coffee and many smoothies.
